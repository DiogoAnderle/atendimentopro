                        ...
                        <div class="col-md-12 grid-center stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('produto.store') }}" class="forms-sample">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-8 resp-col-lg resp-col-sm">
                                                {{-- --------------------------- 
                                                    Dados do Cliente 
                                                --------------------------- --}}
                                                <div class="row">
                                                        ...
                                                        <select class="form-control text-white" id="cliente_id"
                                                            ...
                                                            @foreach ($clientes as $cliente)
                                                                <option value="{{ $cliente->id }}"
                                                                    {{ ($produto->cliente_id ?? old('cliente_id')) == $cliente->id ? 'selected' : '' }}>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-3 resp-col-md resp-col-sm">
                                                        ...
                                                        <select class="form-control text-white" id="tipo_acesso"
                                                            ...
                                                            <option value="VIACLOUD">Viacloud</option>
                                            ...
                                            <div class="col-4 resp-col-lg resp-col-sm">

                                                <div class="row">
                                                    <div class="col-5 resp-col-md resp-col-sm">
                                                        ...
                                                        <div class="form-check form-check-primary">
                                                            <label for="checkImportacao" class="form-label">
                                                                <input type="checkbox" class="checkbox"
                                                                    id="checkImportacao" name="produtos_cliente[]"
                                                                    value="Importação">
                                                                Importação
                                                    ...
                                                    <div class="col-5 resp-col-md resp-col-sm">
                                                        <div class="form-check form-check-primary">
                                                            <label for="checkFinanceiro" class="form-label">
                                                                <input type="checkbox" class="checkbox"
                                                                    name="produtos_cliente[]" id="checkFinanceiro"
                                                                    value="Financeiro">
                                                                Financeiro
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="col-5 resp-col-md resp-col-sm">
                                                        <div class="form-check form-check-primary">
                                                            <label for="checkExportacao" class="form-label">
                                                                <input type="checkbox" class="checkbox"
                                                                    name="produtos_cliente[]" id="checkExportacao"
                                                                    value="Exportação">
                                                                Exportação
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="col-5 resp-col-md resp-col-sm">
                                                        <div class="form-check form-check-primary">
                                                            <label for="checkZeus" class="form-label">
                                                                <input type="checkbox" class="checkbox"
                                                                    name="produtos_cliente[]" id="checkZeus"
                                                                    value="Zeus">
                                                                Zeus
                                                            </label>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-5 resp-col-md resp-col-sm">
                                                        <div class="form-check form-check-primary">
                                                            <label for="checkWsNota" class="form-label">
                                                                <input type="checkbox" class="checkbox" id="checkWsNota"
                                                                    name="produtos_cliente[]" value="WsNota">
                                                                Webservice Nota
                                                            </label>
                                                        </div>
                                                    </div>
