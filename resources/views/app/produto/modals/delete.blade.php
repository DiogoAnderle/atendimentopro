<!-- Modal Excluir-->
<div class="modal fade" id="deleteModal-{{ $produto->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Tem certeza que deseja excluir o produto relacionado ao cliente <br>
                    <strong>{{ $produto->cliente->nomeFantasia }}</strong>?
                </p>
            </div>
