                        ...
                        <div class="col-md-12 grid-center stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('versao_sistema.store') }}" class="forms-sample"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-6 col-xs-12">
                                                ...
                                                <input type="text" class="form-control text-white" id="versao"
                                                    name="versao" autofocus value="{{ old('versao') }}">
                                            ...
                                            <div class="form-group col-6" style="padding-top: 35px;">
                                                ...
                                                <input type="checkbox" id="ultima_versao" name="ultima_versao"
                                                    class="checkbox" value {{ old('ultima_versao') ? 'checked' : '' }} />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control text-white" id="descricao" name="descricao">{{ old('descricao') }}</textarea>
