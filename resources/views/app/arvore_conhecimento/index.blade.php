                            ...
                            <div class="card bg-dark text-white">
                                <div class="card-body">
                                    <div class="position-absolute absolute-position">
                                        <a href="{{ route('arvore_conhecimento.create') }}"
                                                    ...
                                                    <tr>
                                                        @if ($arvoreConhecimento->image != null)
                                                            <td><a a href="" data-bs-toggle="modal"
                                                                    data-bs-target="#imagemModal-{{ $arvoreConhecimento->id }}"><img
                                                                        src="{{ url("storage/{$arvoreConhecimento->image}") }}"
                                                                        alt=""></a>
                                                        ...
                                                        <td class="text-center"><a class=" mdi mdi-eye text-success"
                                                                href="{{ route('arvore_conhecimento.show', $arvoreConhecimento->id) }}"
                                                                title="Detalhes"></a></td>
                                                        <td>{{ $arvoreConhecimento->user->firstName }}</td>
                                                        <td>{{ date('d/m/Y H:m', strtotime($arvoreConhecimento->updated_at)) }}
                                                        </td>
                                                        <td>


                                                            <a href="{{ route('arvore_conhecimento.edit', $arvoreConhecimento->id) }}"
