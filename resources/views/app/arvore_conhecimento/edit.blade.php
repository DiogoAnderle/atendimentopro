                        ...
                        <div class="col-md-12 grid-center stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Atualizar Conhecimento</h4>


                                    <form method="POST"
                                        action="{{ route('arvore_conhecimento.update', $arvoreConhecimento->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-white" id="assunto"
                                                placeholder="Assunto" name="assunto" autofocus
                                                ...
                                                <select class="form-control text-white" id="grupo_id" name="grupo_id"
                                                    ...
                                                    @foreach ($grupos as $grupo)
                                                        <option value="{{ $grupo->id }}"
                                                            {{ ($arvoreConhecimento->grupo_id ?? old('grupo_id')) == $grupo->id ? 'selected' : '' }}>
                                                            {{ $grupo->nome }}</option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select class="form-control text-white" id="subgrupo_id" name="subgrupo_id"
                                                    ...
                                                    @foreach ($subgrupos as $subgrupo)
                                                        <option value="{{ $subgrupo->id }}"
                                                            {{ ($arvoreConhecimento->subgrupo_id ?? old('subgrupo_id')) == $subgrupo->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control text-white" id="descricao" name="descricao"
