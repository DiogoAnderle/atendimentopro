                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-3 resp-col-md resp-col-sm">
                                                ...
                                                <input type="text" class="form-control text-white" id="nomeFantasia"
                                                    name="nomeFantasia"value="{{ $cliente->nomeFantasia ?? old('nomeFantasia') }}">
                                            </div>
                                            ...
                                            <div class="form-group col-1 resp-col-md resp-col-sm">
                                                ...
                                                <select class="form-control text-white" id="status" name="status"
                                                    ...
                                                    @else
                                                        ...
                                                        <option selected value="I">Inativo</option>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-4 resp-col-md resp-col-sm">
                                                ...
                                                <input type="tel" class="form-control text-white" id="telefone"
                                                    name="telefone" value="{{ $cliente->telefone ?? old('telefone') }}"
                                            ...
                                            <div class="form-group col-4 resp-col-md resp-col-sm">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ date('Y-m-d', strtotime($cliente->dataInicioAtividade)) ?? old('dataInicioAtividade') }}">
                                            ...
                                            <div class="form-group col-4 resp-col-md resp-col-sm">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ date('Y-m-d', strtotime($cliente->dataInicioParceria)) ?? old('dataInicioParceria') }}">
