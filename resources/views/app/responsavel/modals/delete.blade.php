<!-- Modal Excluir-->
<div class="modal fade" id="deleteModal-{{$responsavel->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{route('responsavel.destroy', $responsavel->id)}}" method="POST">
                    @csrf
                    @method('DELETE')
