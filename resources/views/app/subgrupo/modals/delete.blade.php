<!-- Modal Excluir-->
<div class="modal fade" id="deleteModal-{{$subgrupo->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    ...
                    Tem certeza que deseja excluir o subgrupo {{$subgrupo->nome}}?
                </p>
            </div>
            ...
            <div class="modal-footer">
                ...
                <form action="{{route('subgrupo.destroy', $subgrupo->id)}}" method="POST">
                    @csrf
                    @method('DELETE')
